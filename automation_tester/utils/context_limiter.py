...
class AgentContextLimiter:
    ...
    limits_by_agent_name: ClassVar[dict[str, int]] = {}
    ...
    def init_context_limiter():
        ...
        def with_context_limits(func: Callable) -> Callable:
            ...
            def wrapper(*args: Any, **kwargs: Any) -> tuple:
                ...
                """
                messages, tools, response_format, generation_params = func(*args, **kwargs)
                ...
                if max_messages and len(messages) > max_messages:
                    ...
                    truncated_messages = AgentContextLimiter._valid_truncate(messages, max_messages)
    ...
    def _find_valid_truncation_point(messages: list, max_count: int) -> int:
        ...
        logger.warning(f"[AgentContextLimiter] 未找到安全截断点，保留所有 {num_messages} 条消息")
        return 0
